...
EOS
  ...
  def test_plus_equals_also_will_leave_the_original_string_unmodified#Оригинальная строка не меняется
  ...
  def test_the_shovel_operator_modifies_the_original_string#Оригинальная строка меняется <<
    original_string = "Hello, "
    hi = original_string
    there = "World"
    hi << there
